...
Webscraping is the subtle art of being a ninja. You need not be an expert on many things but should have a swiss army knife of skills when it comes to data cleaning. String manipulations, sub setting, clever tricks and approximations rather than exact solutions will be your companion on your day to day. This book will skip the usual start from the basics sections to directly giving your results from your efforts. The aim of this primer is to create a plot like this one:
