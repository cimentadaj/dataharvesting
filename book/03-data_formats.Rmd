...
Can you extract the text of the last name of Carol the scientist only using R sub setting rules on your object? For example `some_object$people$person$...` (Hint: `xml2` has a function called `as_list`).
