...
**You'll see that in the remaining part of this chapter I'll use my local path. You should replace this with your local path**. Here's a rough implementation of the bullet points above with comments:
