...
Let's load all the packages we'll use in the chapter. Most of them are related t webscraping or data cleaning. `stringr` will be the package we'll use for doing regular expressions. You'll see that all of the functions of this package begin with `str_`, denoting that they are related to `str`ings:
