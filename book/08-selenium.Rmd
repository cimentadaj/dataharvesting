...
remDr <- rsDriver(port = 4444L, browser = "firefox")
remDr$client$navigate(prep_browser(gelman_blog_ex()))
...
remDr <- rsDriver(port = 4445L, browser = "firefox")
...
remDr$client$navigate(scrapex::prep_browser(scrapex::elpais_newspaper_ex()))
